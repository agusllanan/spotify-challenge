...
function Body({ spotifyApi, chooseTrack }) {
  ...
  return (
    <section className="bg-black ml-24 py-4 space-y-8 md:max-w-6xl flex-grow md:mr-2.5">
      ...
      <div className="grid overflow-y-scroll scrollbar-hide h-96 py-4 grid-cols-2 lg:grids-cols-3 xl:grid-cols-4 gap-x-4 gap-y-8 p-4">
      ...
      <div className="flex gap-x-8 absolute min-w-min md:relative ml-6">
        <div className="hidden xl:inline max-w-[270px]">
          <h2 className="text-white font-bold mb-3">Generos</h2>
          ...
          <button className="btn">Todos los generos</button>
        </div>
        {/* {Tracks} */}
        <div>
          <h2 className="text-white font-bold mb-3">
            {searchResults.length === 0 ? "Nuevos lanzamientos" : "Canciones"}
          </h2>
          <div>
